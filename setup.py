...
setup(
    ...
    description='An AI-powered blog-writing pipeline with code executing  agents using YAML configuration and mock data handling',
    long_description=long_description,
    long_description_content_type='text/markdown',
    url='https://github.com/myaichat/auto_code',
    classifiers=[
